...
from app.operations import addition, subtraction, multiply, division
...
def calculator():
    ...
    while True:
        ...
        if operation == "add":
            ...
            result = multiply(num1, num2)  # We call the multiplication function to multiply the two numbers.
